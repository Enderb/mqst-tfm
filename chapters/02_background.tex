...
qubits the \emph{straddling regime} (where the resonator frequency lies between
the two lowest qubit transition frequencies, $\omega_{01} < \omega_r < \omega_{12}$)
makes this truncation unsafe: the dispersive shifts from the $0\!\to\!1$ and
$1\!\to\!2$ transitions carry opposite signs and partially cancel, so higher levels
