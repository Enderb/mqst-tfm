...
relative to the trigger (\texttt{adc\_trig\_offset}), and whether the integration
window and signal shape are as expected.  The
...
without a quantum-limited parametric amplifier in the chain~\cite{Krantz2019}.
