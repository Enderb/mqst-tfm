...
In practice, a Python loop steps both the generator and readout frequencies
together, runs an \texttt{AveragerProgram} at each point, and records the magnitude
$|I + jQ|$ of the accumulated phasor.  The resonator frequency is identified as the
dip (reflection) or peak (transmission) in the swept amplitude response.
