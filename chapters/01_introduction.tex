...
but also \emph{fast} relative to qubit coherence times.  Crucially for quantum
error correction, it also requires \emph{mid-circuit measurements}: the ability to
measure ancilla qubits repeatedly during a quantum algorithm, use the results to
extract error syndromes in real time, and continue the computation on the data
qubits.  This demands a control electronics stack that can make a state
