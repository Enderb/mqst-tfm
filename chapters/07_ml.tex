...
accuracies: they assign all 800 test shots the same way.  This is not a
coincidence but a consequence of the geometry: the three decision boundaries differ
only in regions of the IQ plane that contain no test shots, so no shot falls between
them.  The QDA result is the informative one: the two IQ clouds do \emph{not} share
