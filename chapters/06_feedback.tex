...
The demo runs on the original v1-style programming interface (\texttt{body},
\texttt{synci}), not the tProcessor v2 API used elsewhere
(Section~\ref{subsec:qick_stack}); the conditional-branch primitive is common to
both.  Registers 1 and 2 are pre-loaded with the threshold and the test value via
