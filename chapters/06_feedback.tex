...
The tProcessor V2 is a soft-processor synthesised in the FPGA fabric, with a
custom instruction set tailored to pulse generation and readout sequencing.  Each
...
readout windows close.  The primitive that matters for feedback is the conditional
