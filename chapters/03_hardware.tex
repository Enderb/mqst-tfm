...
the IP in the loaded overlay, including the data converters, making it
...
\begin{itemize}
      ...
      \item \textbf{tProcessor v2}: a soft-processor that orchestrates pulse timing
            ...
            The build used here runs \texttt{qick\_processor} rev 21 with a
            \SI{200}{\mega\hertz} core execution clock and pulse timing resolved on
            a \SI{614.4}{\mega\hertz} timing clock.
\end{itemize}
