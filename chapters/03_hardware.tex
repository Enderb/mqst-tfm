...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.85\columnwidth]{figures/system_topology}
  \caption{System topology. The tProcessor generates pulse sequences that drive
           the DAC signal generators; the analogue signal passes through the XM655
           front-end to the qubit chip. The reflected/transmitted readout tone is
           routed through the cryogenic chain back to the ADC via the XM655.
           \todo{Replace with actual diagram.}}
